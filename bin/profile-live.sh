...
#
# Why this exists: the perf notes record a 2.4× live-vs-headless gap on
...
# top hot frames go into the perf notes as quoted findings.
#
# Method:
...
echo
echo "(Full report: $SAMPLE_OUT — keep until the findings are written up)"
exit 0
