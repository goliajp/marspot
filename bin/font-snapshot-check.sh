...
MARSPOT_FONT_SNAPSHOT=check cargo nextest run -p marspot --lib \
  ...
  font_v5_cjk_fallback_baseline_snapshot \
  font_v5_emoji_color_snapshot \
  font_v5_opentype_opts_snapshot \
  font_v5_terminal_scene_snapshot \
  font_v5_chrome_decoration_snapshot \
  devpanel_components_catalog_snapshot \
  devpanel_typography_snapshot \
  devpanel_architecture_snapshot \
